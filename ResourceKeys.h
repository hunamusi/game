...
namespace ResourceKeys
{
    ...
    inline constexpr const wchar_t* turnUI = L"turnUI";
    ...
    inline constexpr const wchar_t* Tiles_City_2 = L"Tiles_City_2";
    inline constexpr const wchar_t* Item = L"Item";
    inline constexpr const wchar_t* treasureItem = L"treasureItem";
